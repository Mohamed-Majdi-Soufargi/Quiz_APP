...
import { 
  Brain, ArrowLeft, Mail, Calendar, Award, Trophy, Flame, 
  BookOpen, Target, Edit2, Save, X, Camera, Shield, User
} from 'lucide-react';
...
const StudentProfile = () => {
  ...
  const achievement = getAchievementLevel(profile?.stats?.totalPoints || 0);
